...
![Spotted Lanternflies](https://www.bartlett.com/blog/wp-content/uploads/2024/08/spotted-lanternflies-scaled.jpeg){width=30%} 
![Life Cycle](https://web.uri.edu/biocontrol/wp-content/uploads/sites/2154/SLF_Lifecycle.jpg){width=50%}

Pictures from [Bartlett Tree Experts](https://www.bartlett.com/blog/spotted-lanternfly-control-treatment/)  and [University of Rhode Island](https://web.uri.edu/biocontrol/spotted-lanternfly/slf-distribution-identification-life-cycle/)
...
LdSLdata <- read.csv(paste0(path,"GBIF_Occurrence/Lanternfly_Lycorma_delicatula/occurrence_L-delicatula.csv"), sep=",", header=T)
...
library(raster)
library(viridis)
current<- raster(paste0(path,"Pest Atlas Pages/Predicted Distribution Maps/LdSL_Current_RF-SDM.tif"))
currAgg <- aggregate(current, fact=2)
#res(currAgg)
#length(values(currAgg))
pal <- viridis(n=3600000, option = "turbo")

future <- raster(paste0(path,"Pest Atlas Pages/Predicted Distribution Maps/LdSL_Future_RF-SDM.tif"))
#plot(future)
