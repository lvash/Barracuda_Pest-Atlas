...
HhSBdata <- read.csv("/Users/lvash/Library/Mobile Documents/com~apple~CloudDocs/Desktop/Research/PestSp/GBIF_Occurrence/StinkBug_ Halyomorpha_halys/occurrence_H-halys.csv", sep=",", header=T)
...
library(raster)
library(viridis)
current<- raster("HhSB_Current_RF-SDM_update.tif")
#currAgg <- aggregate(current, fact=2)
#res(currAgg)
#length(values(currAgg))
#pal <- viridis(n=3600000, option = "turbo")

future <- raster("HhSB_Future_RF-SDM_update.tif")
